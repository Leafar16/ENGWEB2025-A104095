exports.studentsListPage = function(slist, d){
        ...
        <body>
            <div class="w3-card-4">
                ...
                <header class="w3-container w3-pink">
                    <h1>Students List
                    <a class="w3-btn w3-square w3-grey" href="/alunos/registo">+</a>
                    </h1>
    ...
    for(let i=0; i < slist.length ; i++){
        pagHTML += `
                <tr>
                    ...
                    <td>
                        <a href="/alunos/edit/${slist[i].id}" class="w3-btn w3-square w3-grey">Edit</a> <a href="/alunos/delete/${slist[i].id}" class="w3-btn w3-square w3-grey">Delete</a>
                    </td>
                </tr>
        `
    }
    ...
    pagHTML += `
                ...
                <footer class="w3-container w3-pink">
                    <h5>Generated na cadeira ENGWEB2025 in ${d}</h5>
                </footer>
            </div>
        </body>
    </html>
        ...
        <body>
            <div class="w3-card-4">
                ...
                <footer class="w3-container w3-teal w3-margin-top">
                    <h5>Generated by EngWeb2025 in ${d} - [<a href="/alunos">Return</a>]</h5>
                </footer>
...
exports.studentFormEditPage = function(a, d){
    ...
    <html>
        ...
        <body>
            <div class="w3-card-4">
                <header class="w3-container w3-orange w3-margin-bottom">
                    <h2>Student Form</h2>
                </header>
...
exports.studentPage = function( aluno, d ){
    ...
    <body>
        <div class="w3-card-4" align="center">
            ...
            <div class="w3-container w3-margin-8" align="center">
                <h3>TPCs por fazer</h3>
                <ul class="w3-ul w3-card-4" style="width:50%">
            `
            for(let i=1; i < 9; i++){
                key = `tpc${i}`
    ...
    pagHTML +=     `</ul></div>
            <footer class="w3-container w3-blue w3-margin-top" align="center">
                <address>Gerado por aluno Rafael Pereira na cadeira de ENGWEB2025 em ${d} - [<a href="/alunos">Voltar</a>]</address>
            </footer>
        </div>
    </body>
    </html>
